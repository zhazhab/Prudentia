...
const translations = {
  en: {
    ...
    "portfolio.performanceSnapshotBasis": "Snapshot-based view; cash flows, dividends, fees, and splits are not adjusted in V1.",
    ...
    "portfolio.benchmarkComparison": "Portfolio vs index proxies",
    "portfolio.benchmarkProxyNote": "Benchmarks use ETF proxies, not official index levels.",
    ...
    "portfolio.benchmarkSse": "SSE proxy",
  ...
  zh: {
    ...
    "portfolio.performanceSnapshotBasis": "基于组合市值快照；V1 不调整出入金、分红、手续费或复权。",
    ...
    "portfolio.benchmarkComparison": "组合 vs 指数代理",
    "portfolio.benchmarkProxyNote": "对比使用 ETF 代理，不是官方指数点位。",
